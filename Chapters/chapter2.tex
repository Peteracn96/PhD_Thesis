...
Ignoring non-local effects is valid if the wavelength of the optical excitation is much larger than the characteristic length scale of the material.
...
Just for illustrative purposes, we give a typical example of a model for the dielectric function that is commonly used to explain and study the optical properties of metals.
