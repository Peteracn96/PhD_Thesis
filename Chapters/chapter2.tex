...
Within the scope of this work, we study only materials with no magnetic response in optical frequencies nor with permanent magnetization, so that $\bM = \bzero$ $\bB \qty(\br,t)  = \mu_0 \bH \qty(\br,t)$ will always hold.

With all these equations in hand, one in principle can solve any problem in electrodynamics in continuous media.
