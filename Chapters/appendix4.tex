...
\begin{equation}
    ...
    \grad  \vdot  \bE(\br,t)=\frac{e}{\epsz}\delta(\br)+\frac{e}{\epsz}n_{\BD}(\br,t)\delta(z),
\end{equation}

\noindent and the continuity equation

\begin{equation}
    -e\frac{\partial n_{\BD}}{\partial t}+\grad  \vdot  \bJ_{\BD}=0\,,
\end{equation}
...
\noindent If we invoke Ohm's law $\bJ_{\BD}(\bk,\omega)=\rttensor{\sigma}(\bk,\omega)\bE(\bk,\omega)$ taking into account the tensor nature of the conductivity, and write the electric field in terms of a potential $\phi$ as $\bE(\bk,\omega)=-\ii\bk\,\phi(\bk,z=0,\omega)$, such that we obtain
