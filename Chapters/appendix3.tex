...
\noindent so the wing terms of the inverse dielectric matrix tend to zero when $\bq$ approaches zero, just as expected for a 2D system~\cite{Guandalini_DAmico_Ferretti_Varsano_2023}. We are in a position now to address the troublesome matrix elements of the screened potential at zero momentum.
