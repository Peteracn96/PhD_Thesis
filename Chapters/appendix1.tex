...
Furthermore, we introduce a new dimensionless parameter $\gamma \equiv r_0 k_0$, so that the integral, after defining $\alpha(\theta) = r_0 k_ 0/(\gamma(\theta) \kappa)$ and performing the radial integral which has an analytical expression, becomes now
