...
\begin{equation}
    \Delta_{ex} = \frac{1}{A} \sum_{\bp} V_{\bp} \left[F_{vvvv}(\bp ,0,\bp) - F_{vcvc}(\bp,0,\bp) \right] \,.
\end{equation}
...
Now we take the difference between the form factors
...
\begin{equation}
    \begin{split}
        ...
        &= \frac{1}{\sqrt{1 + \frac{p^2 \gamma(\theta)}{k_0^2}}} \,,
    \end{split}
\end{equation}
...
\begin{equation}
    \Delta_{ex} = \frac{1}{A} \sum_{\bp} V_{\bp}  \frac{1}{\sqrt{1 + \left(\frac{p \gamma(\theta)}{k_0}\right)^2}} = \frac{e}{8 \pi^2 \epsz \kappa} \int_0^{2\pi} \dd \theta \int_0^{\infty} \dd p  \frac{1}{ (1 + r_0 p/\kappa) \sqrt{1 + \left(\frac{p \gamma(\theta)}{k_0}\right)^2}} \,.
\end{equation}
...
The differential becomes $ \dd p = k_0 \dd(\tan u)/\gamma(\theta) =  \frac{k_0}{\gamma(\theta) \cos^2 u}\, \dd u$, and the square root in the denominator transforms into $\sqrt{1 + p^2 \gamma^2(\theta)/k_0^2} = \sqrt{1 + \tan^2 u} = 1/\cos u$.
...
\todo{Do push of the changes made in this appendix in the station}
\begin{equation}
    \begin{split}
        \int_0^{2\pi} \dd \theta
    \end{split}
...
\begin{equation}
    \Delta_{ex} = \frac{\hbar c \alpha}{\varepsilon} \frac{k_0}{\sqrt{1 + \gamma^2}} \ln \left( \frac{1 + \gamma + \sqrt{1 + \gamma^2}}{1 + \gamma - \sqrt{1 + \gamma^2}} \right) \,.
\end{equation}
