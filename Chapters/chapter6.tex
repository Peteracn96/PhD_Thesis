...
We stress that the prefactor of $2$ and the sum over spins $\sigma$ are key to get the screening properties right.
...
\subsection{\gls{hbn} revisited: DFT band structure and Hamiltonian model}
