...
\begin{equation}
    ...
    \begin{aligned}
        \chi^0_{\bG\bG'}(\bq,\omega = 0) = & \frac{1}{A} \sum_{v c,\bk \sigma} \Bigg[\frac{\langle c,\bk| \ee^{-\ii(\bq+\bG)\cdot\br}|v,\bk+\bq\rangle\langle v,\bk+\bq| \ee^{i(\bq+\bG')\cdot\br}|c,\bk\rangle}{\epsilon_{v,\bk+\bq}-\epsilon_{c,\bk}} \Bigg] + \\
        & \frac{1}{A} \sum_{v c,\bk \sigma} \Bigg[\frac{\langle v,\bk| \ee^{-\ii(\bq+\bG)\cdot\br}|c,\bk+\bq\rangle\langle c,\bk+\bq| \ee^{i(\bq+\bG')\cdot\br}|v,\bk\rangle}{\epsilon_{v,\bk} - \epsilon_{c,\bk+\bq}}\Bigg] \,.
    \end{aligned}
\end{equation}
