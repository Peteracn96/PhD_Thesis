...
\noindent in the static approximation, which we will have to justify at some point, when we are about to compute the excitons.
...
Something similar has seen before in other works in the literature, such as Ref.~\cite{BerkeleyGW}, in figure 4 therein.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Chapters/Figures/Chapter_6/Chi00hBNDFTq1&q2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Electrons_in_solids/Screening/Chi00hBNDFTmesh.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Electrons_in_solids/Screening/ChiG1_0hBNDFTmesh}
