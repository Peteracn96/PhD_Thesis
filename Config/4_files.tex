...
%%------------------------------------------------------------
% File with the biography text. Will only be considered for final documents,
%   i.e., "bsc", "msc" and "phd", otherwise, it will be silently ignored
%   syntax: \ntaddfile{biography}{filename}
\ntaddfile{biography}{biography}
...
\ntaddfile{abstract}[dk]{abstract-dk}  % Abstract in Danish
