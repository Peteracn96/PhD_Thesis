...
\newcommand{\mycaption}[2][]{\caption[#1]{\small\textbf{#1}. #2}}

% Command for panels of figures mentioned in the text
\providecommand{\pnl}[1]{{\textcolor{black}{\mbox{\textbf{#1}}}}}
...
\newcommand{\mbpt}{many-body perturbation theory}
...
%Commands just for the GW approximation, either italic or not
...
\newif\ifusevb
\usevbtrue  % For bold upright, set it to true (\usevbfalse for false to set it in bold italic)
...
%    \providecommand{\bez}{\vb{e}_z}
    ...
    \providecommand{\bex}{\uvec{x}}
    \providecommand{\bey}{\uvec{y}}
    \providecommand{\bez}{\uvec{z}}
...
\newif\ifusebm
\usebmtrue % For bold italic, set it to true (\usebmfalse for false to set it upright)
...
% Ground state in math mode
\newcommand{\GS}{\mathrm{GS}}

% Struve special function
\newcommand{\Hz}{\mathbf{H}_0}

% tot, ext and ind in math mode
\newcommand{\tot}{\mathrm{tot}} % total
\newcommand{\ext}{\mathrm{ext}} % external
\newcommand{\ind}{\mathrm{ind}} % induced

% inc, r and t in math mode (incident, reflected and transmitted)
\newcommand{\inc}{\mathrm{inc}} % total
\newcommand{\refl}{\mathrm{r}} % external
\newcommand{\trans}{\mathrm{t}} % induced
...
% Fermi velocity
\newcommand{\vF}{v_{F}} % We have to redefine the command, as by default in the amsmath package it stands for the Weierstrass function (the curly P)
...
% Unit cell in math mode
\newcommand{\UC}{\mathrm{UC}}

% Unit vector command
\newcommand{\uvec}[1]{\boldsymbol{\hat{\textbf{#1}}}}

% Valence and conduction band indeces
\renewcommand{\vv}{v}
\newcommand{\cc}{c}

% Xatu code
\newcommand{\xatu}{\texttt{Xatu}}
\newcommand{\CC}{{C\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\tiny++}}}
% Colors
\definecolor{lightgray}{HTML}{D3D3D3}
\definecolor{Color2}{rgb}{0.0, 0.22, 0.62}

% Custom colorbox
\newtcolorbox[auto counter,number within=section]{mybox}[2]{%
sharp corners, colframe=blue!80!black,breakable, colback=blue!10, fonttitle=\bfseries,label=#2,
