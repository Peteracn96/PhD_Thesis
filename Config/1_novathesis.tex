...
%-------------------------------------------------------------
\ntsetup{abstractorder={en,dk}}   % The order for abstracts for the main language
...
%-------------------------------------------------------------
  \ntsetup{style/font=kieranhealy}   % You can use any of the default LaTeX style files:
...
%-------------------------------------------------------------
\ntsetup{spine/layout=no}    % Print the “book spine” at the end of the document?
