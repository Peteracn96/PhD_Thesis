...
\usepackage[many]{tcolorbox}    % pretty print color boxes
...
% \usepackage{minted}    % Fontification of source code listings % Gives No room for a new \write error
...
\usepackage{cancel}
%
\usepackage{shortvrb} % teletype format
%%%%%Package for more mathematical commands%%%%
\usepackage{bm}
%
...
%
%%%%%Package for command line input%%%%
\usepackage{listings}
...
%\usepackage{feynmf} % Gives No room for a new \write error
%

%%%%% To insert cover and contra cover%%%%
\usepackage{pdfpages}

%%%%%Package for compilation options%%%%
\usepackage{ifthen}
...
%%%%%Package for fancy ruler%%%%%
\usepackage[object=vectorian]{pgfornament} %%  http://altermundus.com/pages/tkz/ornament/index.html
%
%%%%%% MY OWN SHORTCUTS %%%%%
\input{Config/shortcuts}
